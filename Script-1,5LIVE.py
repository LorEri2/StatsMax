...
def analyser_series_en_cours_moins_1_5(df, equipes):
    """
    Calcule la série en cours pour -1.5 buts (0 ou 1) pour chaque équipe.
    """
    ...
    # Condition : -1.5 buts (0 ou 1 but)
    df['ConditionMet'] = df['TotalGoals'] < 1.5 # Équivalent à <= 1
    ...
    for equipe in equipes:
        ...
        resultats.append({
            ...
            'Série_en_cours_moins_1_5': serie_en_cours
        })
    ...
    if resultats:
        ...
        # --- CLÉ DE TRI MODIFIÉE ---
        df_rapport = df_rapport.sort_values(by='Série_en_cours_moins_1_5', ascending=False)
        
        # --- TITRE MODIFIÉ ---
        print("\n--- Séries en cours : Matchs avec -1.5 Buts (0 ou 1 but) ---")
...
if __name__ == "__main__":
    ...
    if donnees_completes is not None:
        ...
        if equipes_a_analyser:
            ...
            analyser_series_en_cours_moins_1_5(donnees_completes, equipes_a_analyser)