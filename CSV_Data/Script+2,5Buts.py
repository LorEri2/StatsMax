    ...
    try:
        ...
        <style>
            ...
            .styled-table thead tr {
                background-color: #009879; /* Couleur de l'en-tête */
                color: #ffffff;
                text-align: left;
            }
            .styled-table th,
...
def trouver_record_serie_plus_2_5_buts(df, nom_equipe):
    ...
    df_equipe['Over2_5'] = df_equipe['TotalGoals'] > 2.5 
...
if __name__ == "__main__":
    ...
    if not fichiers_historique:
        ...
        if donnees_completes is not None:
            ...
            # Définissez le titre et le nom du fichier ici
            titre_du_rapport = "Record Historique des Séries +2.5 Buts (Premier League)"
            nom_du_fichier_html = "rapport_plus_2_5_buts.html"
